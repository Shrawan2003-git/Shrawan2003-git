...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Poppins&size=24&pause=1000&color=8B5CF6&center=true&vCenter=true&width=800&lines=Building+Real-World+Web+Applications;MERN+Stack+Developer;AI-Integrated+Project+Builder;AWS+%7C+MongoDB+%7C+React+%7C+Node.js;Passionate+About+Modern+Web+Technologies)](https://git.io/typing-svg)
...
A smart navigation system for college campuses with:
...
### 🛠️ Tech Used
React.js • Node.js • MongoDB • PathFinding.js • Tailwind CSS
